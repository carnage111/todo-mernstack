...
//here even if you generate the token with the same payload and secret key, the token will be different, because the token is generated with different iat and exp values, which causes the token to be different, even if the user and payload is same
